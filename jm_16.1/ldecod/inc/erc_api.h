...
extern void conceal_one_lost_frame(VideoParameters *p_Vid,int logPOC,int logFrameNum);
extern void conceal_one_lost_non_ref_frame(VideoParameters *p_Vid,int logPOC,int logFrameNum);
extern void conceal_lost_non_ref_frames(VideoParameters *p_Vid, StorablePicture *picture);	// YD
